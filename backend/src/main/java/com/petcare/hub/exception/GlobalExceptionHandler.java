 ...
 * follows the same shape: { timestamp, status, error, message, path? , fieldErrors? }
 */
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleMaxUpload(MaxUploadSizeExceededException ex) {
        return buildResponse(HttpStatus.PAYLOAD_TOO_LARGE, "Uploaded file exceeds the maximum allowed size (10MB)", null);
    }
    ...
    public ResponseEntity<Map<String, Object>> handleValidation(MethodArgumentNotValidException ex) {
        ...
        return buildResponse(HttpStatus.BAD_REQUEST, "Validation failed for one or more fields", fieldErrors);
    }
